...
# в классе paginate_by = 3 - количество статей на странице
# в функции:
...
#   return render(request, 'service/about.html', {'page_obj': page_obj, 'menu': menu, 'title': "О сайте"})
...
# Пагинация для класса представления смотри в коде...
...
# pip install django-debug-toolbar -> устанавливаем в виртуальном окружении (venv)
...
# Ленивые - отложенные запросы выполняются в момент непосредственного обращения к данным (используются в единичных)
